        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <a href="#infrastructure" className="text-slate-300 hover:text-white transition-colors">
                Infrastructure
              </a>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-slate-800/50 border-slate-700 hover:border-cyan-500/50 transition-colors">
              <CardHeader>
                ...
                <CardDescription className="text-slate-300">
                  Custom design and deployment of 1 to 10 megawatt (MW) modular natural gas AI factories across Alberta. Scalable, self-contained units engineered for rapid deployment and optimized for GPU-intensive workloads.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="bg-slate-800/30 border border-slate-700 rounded-lg p-6">
              ...
              <p className="text-slate-300">
                Clean, stable power engineered for sensitive GPU hardware with advanced voltage regulation and power conditioning.
              </p>
            </div>
            <div className="bg-slate-800/30 border border-slate-700 rounded-lg p-6">
              <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-slate-300">
                Physical and digital security protocols designed to protect mission-critical AI infrastructure around the clock.
              </p>
            </div>
            <div className="bg-slate-800/30 border border-slate-700 rounded-lg p-6">
              <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-slate-300">
                Modular power systems that scale with your compute needs, from initial deployment to full production capacity.
              </p>
            </div>
            <div className="bg-slate-800/30 border border-slate-700 rounded-lg p-6">
              <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-slate-300">
                Direct access to Alberta's abundant natural gas reserves ensures long-term price stability and supply security.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                <li><a href="#services" className="hover:text-white transition-colors">Power Generation</a></li>
                <li><a href="#services" className="hover:text-white transition-colors">Data Center Power</a></li>
                <li><a href="#services" className="hover:text-white transition-colors">Energy Monitoring</a></li>
              </ul>
            </div>
